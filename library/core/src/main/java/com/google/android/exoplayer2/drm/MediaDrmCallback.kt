...
interface MediaDrmCallback {
    ...
    fun executeProvisionRequest(uuid: UUID?, request: ExoMediaDrm.ProvisionRequest?): ByteArray?
     ...
     */
    @Throws(MediaDrmCallbackException::class)
    fun executeKeyRequest(uuid: UUID?, request: ExoMediaDrm.KeyRequest?): ByteArray?
}