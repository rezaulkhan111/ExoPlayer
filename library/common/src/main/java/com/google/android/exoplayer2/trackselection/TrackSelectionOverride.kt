 ...
 */
class TrackSelectionOverride constructor(mediaTrackGroup: TrackGroup, trackIndices: List<Int>) : Bundleable {
    ...
    @IntDef([TrackSelectionOverride.Companion.FIELD_TRACK_GROUP, TrackSelectionOverride.Companion.FIELD_TRACKS])
     ...
     */
    constructor(mediaTrackGroup: TrackGroup, trackIndex: Int) : this(mediaTrackGroup, ImmutableList.of<Int>(trackIndex)) {}
    ...
    public override fun equals(obj: Any?): Boolean {
        ...
        val that: TrackSelectionOverride = obj as TrackSelectionOverride
    ...
    public override fun toBundle(): Bundle {
        ...
        bundle.putBundle(TrackSelectionOverride.Companion.keyForField(TrackSelectionOverride.Companion.FIELD_TRACK_GROUP), mediaTrackGroup.toBundle())
        bundle.putIntArray(TrackSelectionOverride.Companion.keyForField(TrackSelectionOverride.Companion.FIELD_TRACKS), Ints.toArray(trackIndices))
        return bundle
    }
    ...
    companion object {
        ...
        private val FIELD_TRACKS: Int = 1

        /** Object that can restore `TrackSelectionOverride` from a [Bundle].  */
        val CREATOR: Bundleable.Creator<TrackSelectionOverride> = Bundleable.Creator({ bundle: Bundle ->
            val trackGroupBundle: Bundle? = Assertions.checkNotNull(bundle.getBundle(TrackSelectionOverride.Companion.keyForField(TrackSelectionOverride.Companion.FIELD_TRACK_GROUP)))
            val mediaTrackGroup: TrackGroup = TrackGroup.Companion.CREATOR.fromBundle((trackGroupBundle)!!)
            val tracks: IntArray? = Assertions.checkNotNull(bundle.getIntArray(TrackSelectionOverride.Companion.keyForField(TrackSelectionOverride.Companion.FIELD_TRACKS)))
            TrackSelectionOverride(mediaTrackGroup, Ints.asList(*tracks))
        })

        private fun keyForField(@TrackSelectionOverride.FieldNumber field: Int): String {
