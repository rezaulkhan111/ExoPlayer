 ...
 *
 */
package com.google.android.exoplayer2.text.spanimportimport

com.google.android.exoplayer2.text.span.LanguageFeatureSpan androidx.annotation .IntDef
 ...
 *
 *
 * This is used in vertical text to write some characters in a horizontal orientation, known in
 * Japanese as tate-chu-yoko.
 *
 *
 * More information on [tate-chu-yoko](https://www.w3.org/TR/jlreq/#handling_of_tatechuyoko) and [span styling](https://developer.android.com/guide/topics/text/spans).
 */
...
class HorizontalTextInVerticalContextSpan : LanguageFeatureSpan