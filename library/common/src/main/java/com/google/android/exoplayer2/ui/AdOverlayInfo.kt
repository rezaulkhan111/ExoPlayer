 ...
 */
package com.google.android.exoplayer2.uiimport

import android.view.*
import com.google.android.exoplayer2.ui.AdOverlayInfo

java.lang.annotation .Documentedimport java.lang.annotation .Retentionimport java.lang.annotation .RetentionPolicy androidx.annotation .IntDef
import com.google.android.exoplayer2.ui.AdOverlayInfo
...
class AdOverlayInfo @Deprecated("Use {@link Builder} instead.") constructor(
        /** The overlay view.  */
        val view: View?,
        /** The purpose of the overlay view.  */
        val purpose: @AdOverlayInfo.Purpose Int,
    ...
    @IntDef([AdOverlayInfo.Companion.PURPOSE_CONTROLS, AdOverlayInfo.Companion.PURPOSE_CLOSE_AD, AdOverlayInfo.Companion.PURPOSE_OTHER, AdOverlayInfo.Companion.PURPOSE_NOT_VISIBLE])
     ...
     */(private val view: View, private val purpose: @AdOverlayInfo.Purpose Int) {
    ...
    constructor(view: View?, purpose: @AdOverlayInfo.Purpose Int) : this(view, purpose,  /* detailedReason= */null) {
    }
