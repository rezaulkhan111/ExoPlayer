...
/**
 * Interface for classes whose instance can be stored in a [Bundle] by [.toBundle] and
 * can be restored from the [Bundle] by using the static `CREATOR` field that implements
 * [Bundleable.Creator].
 *
 *
